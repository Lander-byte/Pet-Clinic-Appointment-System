...
public class CustomersScreen extends JPanel {
    ...
    private void refreshTable() {
        model.setRowCount(0);
        List<Owner> customers = accountStore.getCustomers();
    ...
    private void showAddCustomerDialog() {
        ...
        panel.add(name); panel.add(email); panel.add(phone);
        ...
        if (result == JOptionPane.OK_OPTION) {
            try {
                ...
                Owner owner = accountStore.registerCustomer(name.getText(), email.getText(), "password123");
